...
/* extension/module/wd_category_list.twig */
class __TwigTemplate_17f51beb921ade7b38510a6eb51d55d38e621099365e34f98983c0539e3cd75a extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t  ";
    ...
    ";
      ...
      <div class=\"panel-body\">
        ...
        echo "\" method=\"post\" enctype=\"multipart/form-data\" id=\"form-wd_category_list\" class=\"form-horizontal\">
...
\t\t
\t\t\$('#list-category' + item['value']).remove();
\t\t
\t\t\$('#list-category').append('<div id=\"list-category' + item['value'] + '\"><i class=\"fa fa-minus-circle\"></i> ' + item['label'] + '<input type=\"hidden\" name=\"category[]\" value=\"' + item['value'] + '\" /></div>');\t
\t}
});
\t
...
";
    ...
    {
        return "extension/module/wd_category_list.twig";
    }
    ...
    {
        return new Source("", "extension/module/wd_category_list.twig", "");
    }
}
